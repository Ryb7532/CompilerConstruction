...
class Yylex(in: Reader)  {
  ...
  private final val ZZ_ROWMAP_PACKED_0: String =
    "\u0000\u0000\u0000\u001d\u0000\u003a\u0000\u0057\u0000\u0074\u0000\u0091\u0000\u00ae\u0000\u00cb\u0000\u00e8\u0000\u0105\u0000\u0122\u0000\u013f\u0000\u015c\u0000\u0179\u0000\u0196\u0000\u01b3\u0000\u01d0\u0000\u01ed\u0000\u020a\u0000\u0227\u0000\u0244\u0000\u0261\u0000\u027e\u0000\u029b\u0000\u0057\u0000\u02b8\u0000\u02d5\u0000\u02f2\u0000\u030f\u0000\u032c\u0000\u0349\u0000\u0366\u0000\u0383\u0000\u03a0\u0000\u03bd\u0000\u03da\u0000\u03f7\u0000\u0414\u0000\u0431\u0000\u044e\u0000\u046b\u0000\u0488\u0000\u04a5\u0000\u04c2"
    ...
    while ((ret == null) && !zzAtEOF) {
      ...
      ret = if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        (if (zzAction < 0) zzAction else ZZ_ACTION(zzAction)) match {
          ...
          case 44 => null // noop
          case 19 => 
             Tokens.IDBR(yytext().substring(0, yytext().length-1))
          case 45 => null // noop
          case 20 => 
             Tokens.IF
          case 46 => null // noop
